...
use \WebSockets\WebSocketUser;

namespace WebSockets;
abstract class WebSocketServer {

  protected $userClass = '\WebSockets\WebSocketUser'; // redefine this if you want a custom user class.  The custom user class should inherit from WebSocketUser.
